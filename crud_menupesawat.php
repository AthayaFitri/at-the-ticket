        ...
        <nav class="fixed-top bg-light">
            <div class="container">
                <ol>
                    ...
                    <li><a href="crud_menupesawat.php" class="active">Jadwal Pesawat</a></a></li>
                    <li><a href="crud_menukereta.php">Jadwal Kereta Api</a></a></li>
                ...
                <form action="cari_tiket.php" method="POST">
                        ...
                        <select class="form-select" name="asal" id="asal">
                            ...
                            <?php 
                                $sql = "SELECT *, tempat.nama_tempat FROM kota JOIN tempat ON kota.id_kota = tempat.id_kota
                                        WHERE tempat.id_transportasi_tipe = 1";
                                $cekkota = query($sql);
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="kelas" id="kelas">
                            ...
                            <?php 
                                $sql = "SELECT * FROM transportasi_kelas WHERE id_transportasi_tipe = 1";
                                $cekkelas = query($sql);
                                foreach($cekkelas as $row) :
                            ?>
                            <option value=" <?= $row['id_transportasi_kelas']; ?>"><?= $row['nama_kelas']; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="penumpang">Jumlah Penumpang</label>
                        <input class="form-control" type="number" name="penumpang" id="penumpang">
                    </div>
                    <div class="mb-3">
